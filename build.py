...
def archive_recruitment(lang):
    ...
    intern_title='科研实习生' if zh else 'Research Interns'
    intern_copy='实验室具备充足的具身智能、GPU、NPU 与 CPU 等研究资源，并长期开放科研实习岗位。' if zh else 'Our lab provides abundant resources for embodied intelligence, GPU, NPU, and CPU research, with research internship positions available.'
